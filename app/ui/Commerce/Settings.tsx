...
const Settings = (props: Props) => {
  ...
  <div className='text-center w-full mb-5'>
    ...
    {/* Tab Nav */}
    <nav
      className="max-w-6xl mx-auto grid sm:flex  sm:gap-y-0 sm:gap-x-4"
      aria-label="Tabs"
      role="tablist"
    >
      <button
        type="button"
        className="hs-tab-active:bg-gray-100 hs-tab-active:hover:border-transparent w-full flex flex-col text-start hover:bg-gray-100 p-3 md:p-5 rounded-xl dark:hs-tab-active:bg-white/[.05] dark:hover:bg-purple-100 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600 active"
      ...
      >
        <svg
          className="flex-shrink-0 hidden sm:block h-7 w-7 hs-tab-active:text-green-600 text-gray-800  "
        ...
        <span className="mt-5">
          <span className="hs-tab-active:text-green-600 block font-semibold text-gray-800  ">
          Currency Control Center
          </span>
          <span className="hidden lg:block mt-2 text-gray-800 ">
          Effortlessly manage store currencies for a seamless financial journey.
          </span>
        </span>
      </button>
      <button
        type="button"
        className="hs-tab-active:bg-gray-100 hs-tab-active:hover:border-transparent w-full flex flex-col text-start hover:bg-gray-100 p-3 md:p-5 rounded-xl dark:hs-tab-active:bg-white/[.05] dark:hover:bg-purple-100 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
      ...
      >
        ...
        <span className="mt-5">
          <span className="hs-tab-active:text-green-600 block font-semibold text-gray-800 ">
          Global Reach Mastery
          </span>
          <span className="hidden lg:block mt-2 text-gray-800 ">
          Effortless Control over Regions and Shipping Methods!
          </span>
        </span>
      </button>
      <button
      ...
      >
        ...
        <span className="mt-5">
          <span className="hs-tab-active:text-green-600 block font-semibold text-gray-800 ">
          Sales Channel Maestro
          </span>
          <span className="hidden lg:block mt-2 text-gray-800 ">
          Optimize your store's success with our Sales Channel Maestro
          </span>
        </span>
      </button>
    </nav>
        ...
        <div className="max-w-[1140px] lg:pb-32 relative">
          ...
          <figure className="ms-auto me-20 relative z-[1] max-w-full w-[50rem] h-auto rounded-b-lg shadow-shadow-[0_2.75rem_3.5rem_-2rem_rgb(0_0_0_/_20%),_0_0_5rem_-2rem_rgb(0_0_0_/_15%)]">
            <div className="relative flex items-center max-w-[50rem] bg-gray-800 border-b border-gray-700 rounded-t-lg py-2 px-24">
              ...
              <div className="flex justify-center items-center w-full h-full bg-gray-700 text-[.25rem] dark:text-gray-200  rounded-sm sm:text-[.5rem]">
                www.bucksbox-admin.in
              </div>
            </div>
            <div className="bg-gray-800 rounded-b-lg">
